       ...
       <div id="frame-form-pengiriman">
           ...
           <form action="<?php echo BASE_URL . "proses_pemesanan.php"; ?>" method="POST">
               ...
               <div class="element-form">
                   ...
                   <span><input type="text" id="nama_penerima" name="nama_penerima"></span>
               </div>


               <div class="element-form">
                   <label for="nomor_telepon">Nomor Telepon</label>
                   <span><input type="text" id="nomor_telepon" name="nomor_telepon"></span>
               </div>
       ...
       <div id="frame-detail-order">
           ...
           <table class="table-list">
               ...
               <?php
                ...
                echo "<tr>
                        <td colspan='2' class='kanan'><b>Total Harga</b></td>
