...
if (mysqli_num_rows($queryBanner) == 0) {
    ...
    echo "<tr class='baris-title'>
                    ...
                    <th class='tengah'>Banner</th>
                    <th class='tengah'>Link</th>
    ...
    while ($rowBanner = mysqli_fetch_array($queryBanner)) {
        echo "<tr>
                        ...
                        <td class='tengah'>$rowBanner[banner]</td>
                        <td class='tengah'><a target='blank' href='" . BASE_URL . "$rowBanner[link]'>$rowBanner[link]</a></td>
