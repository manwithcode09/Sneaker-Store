...
$query = mysqli_query($koneksi, "SELECT pesanan.pesanan_id, pesanan.nama_penerima, pesanan.nomor_telepon, 
pesanan.alamat, pesanan.tanggal_pemesanan, user.nama, kota.kota, kota.tarif
FROM pesanan JOIN user ON pesanan.user_id=user.user_id JOIN kota ON kota.kota_id=pesanan.kota_id 
...
<table class="table-list">
    ...
    <tr class="baris-title">
        ...
        <td class="tengah"><b>Jumlah</b></td>
        <td class="kanan"><b>Harga Satuan</b></td>
        <td class="kanan"><b>Total</b></td>
    </tr>

    <?php

    $querydetail = mysqli_query($koneksi, "SELECT pesanan_detail.*, barang.nama_barang FROM pesanan_detail 
...
<div id="frame-keterangan-pembayaran">
    <p>Silahkan Lakukan pembayaran ke Bank XNXX<br />
        Nomor Rekening : 0000-9999-8888 (A/N Callmedude)<br />
